        ...
        <div class="container debug">
            <div class="nav debug flex">
                ...
                <div class="contacts flex debug text-center column">
                    <p>Avada Barbers<br>123 New York Street<br>New York City<br>info@yourwebsite.com<br>+1 (555)
                        555-1212</p>
            ...
            <div class="copyright debug">
                <p class="center">&copy; Copyright 2024 | Avada Theme by Daniele Colaci | All Rights Reserved | Powered
                    by Boolean</p>
            </div>
        </div>
    </footer>
